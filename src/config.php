 ...
 * Minify config.php
 *
 * Completely optional configuration settings for Minify if you want to customize some
 * of its more esoteric behavior, or just want specific control over things.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'minify.php' and make
 * your changes there.
 *
